...
router.post("/create-checkout-session", async (req, res) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: "https://paymentserver-production-f241.up.railway.app/stripe/checkout-success",
    cancel_url:  "https://paymentserver-production-f241.up.railway.app/stripe/cancel",
  });
